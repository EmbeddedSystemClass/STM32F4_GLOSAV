...
/* Pin settings */
#define ONEWIRE_LOW()			  HAL_GPIO_WritePin(in_1_wire_in_GPIO_Port, in_1_wire_in_Pin, GPIO_PIN_RESET)
#define ONEWIRE_HIGH()			HAL_GPIO_WritePin(in_1_wire_in_GPIO_Port, in_1_wire_in_Pin, GPIO_PIN_SET)
