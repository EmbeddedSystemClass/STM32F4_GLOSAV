...
#define CASE_OPEN_SW_PORT		GPIOG
#define CASE_OPEN_SW_PIN		GPIO_PIN_0

#define CASE_OPEN_O_PORT		GPIOG
#define CASE_OPEN_O_PIN			GPIO_PIN_1
...
void DiscreteOutputs_SetState(uint8_t outputs)
{
		...
		HAL_GPIO_WritePin(CASE_OPEN_SW_PORT,	CASE_OPEN_SW_PIN,	outputs&(1<<CASE_OPEN_SW_BIT));
		HAL_GPIO_WritePin(CASE_OPEN_O_PORT,		CASE_OPEN_O_PIN,	outputs&(1<<CASE_OPEN_O_BIT));
}